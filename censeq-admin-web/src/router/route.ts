			...
			},
			{
				...
				children: [
						...
						children: [
							{
								...
								component: () => import('/@/views/system/localization/index.vue'),
								meta: {
									title: '翻译条目',
									isLink: '',
									isHide: false,
							...
							},
							{
								...
								component: () => import('/@/views/system/localization/resource.vue'),
								meta: {
									title: '资源管理',
									isLink: '',
									isHide: false,
							...
							},
							{
								...
								component: () => import('/@/views/system/localization/culture.vue'),
								meta: {
									title: '语言管理',
									isLink: '',
									isHide: false,
					...
					},
					{
						...
						meta: {
							title: 'message.router.platformLogs',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
						...
						children: [
							...
							},
							{
								...
								component: () => import('/@/views/platform/security-log/index.vue'),
								meta: {
			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						component: () => import('/@/views/system/tenant-menu/index.vue'),
						meta: {
							title: '菜单配置',
							isLink: '',
							isHide: false,
...
export const staticRoutes: Array<RouteRecordRaw> = [
	...
	},
	{
		...
		component: () => import('/@/views/callback/logout-callback.vue'),
		meta: {
			title: '退出回调',
		},
	},
