...
namespace Censeq.Admin.Web.Pages.Account;
...
public class LoginModel : AccountPageModel
{
    ...
    public virtual async Task<IActionResult> OnGetAsync()
    {
        ...
        EnableRememberMe = await SettingProvider.IsTrueAsync(AdminSettingNames.EnableRememberMe);
        ShowCancelButton = await SettingProvider.IsTrueAsync(AdminSettingNames.ShowCancelButton);
        IsSelfRegistrationEnabled = await SettingProvider.IsTrueAsync(AdminSettingNames.IsSelfRegistrationEnabled);
    ...
    public virtual async Task<IActionResult> OnPostAsync(string action)
    {
        ...
        {
            ModelState.AddModelError(string.Empty, L["UserLockedOutMessage"]);
            return Page();
        }

        if (result.IsNotAllowed)
        {
            ModelState.AddModelError(string.Empty, L["LoginIsNotAllowed"]);
            return Page();
        }

        if (!result.Succeeded)
        {
            ModelState.AddModelError(string.Empty, L["InvalidUserNameOrPassword"]);
            return Page();
        }
