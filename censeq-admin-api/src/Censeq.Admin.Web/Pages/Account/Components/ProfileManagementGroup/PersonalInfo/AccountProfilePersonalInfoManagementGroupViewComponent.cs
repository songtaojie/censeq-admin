...
using Censeq.Admin.Application.Contracts.Account;
...
namespace Censeq.Admin.Web.Pages.Account.Components.ProfileManagementGroup.PersonalInfo;
...
public class AccountProfilePersonalInfoManagementGroupViewComponent : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        var model = ObjectMapper.Map<ProfileOutput, PersonalInfoModel>(user);
