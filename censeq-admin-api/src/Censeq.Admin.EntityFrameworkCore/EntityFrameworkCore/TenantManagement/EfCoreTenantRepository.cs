...
/// </summary>
public class EfCoreTenantRepository : EfCoreRepository<StarshineAdminDbContext, Tenant, Guid>, ITenantRepository
{
    public EfCoreTenantRepository(IDbContextProvider<StarshineAdminDbContext> dbContextProvider, IAbpLazyServiceProvider abpLazyServiceProvider):base(dbContextProvider)
    {
