...
namespace Censeq.Admin.Migrations
{
    ...
    [Migration("20260531142418_AddIdentityClaimTypeOptions")]
    partial class AddIdentityClaimTypeOptions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Censeq.FileManagement.Files.FileRecord", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_censeq_file_record");

                    b.HasIndex("Url")
                        .HasDatabaseName("ix_censeq_file_record_url");

                    b.HasIndex("TenantId", "Category", "CreationTime")
                        .HasDatabaseName("ix_censeq_file_record_tenant_id_category_creation_time");

                    b.ToTable("censeq_file_record", (string)null);
                });
