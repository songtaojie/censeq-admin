        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    storage_provider = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_censeq_permission_group", x => x.id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_censeq_permission_group_name",
                table: "censeq_permission_group",
                column: "name",
                unique: true);
