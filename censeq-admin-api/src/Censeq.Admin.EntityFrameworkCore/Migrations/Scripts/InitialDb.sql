...
CREATE TABLE censeq_localization_culture (
    id uuid NOT NULL,
    tenant_id uuid,
    culture_name character varying(10) NOT NULL,
    ui_culture_name character varying(10),
    ...
    last_modification_time timestamp without time zone,
    last_modifier_id uuid,
    CONSTRAINT pk_censeq_localization_culture PRIMARY KEY (id)
);

CREATE TABLE censeq_localization_resource (
    id uuid NOT NULL,
    name character varying(128) NOT NULL,
    display_name character varying(128),
    default_culture_name character varying(10),
    extra_properties text NOT NULL,
    concurrency_stamp character varying(40) NOT NULL,
    creation_time timestamp without time zone NOT NULL,
    creator_id uuid,
    last_modification_time timestamp without time zone,
    last_modifier_id uuid,
    CONSTRAINT pk_censeq_localization_resource PRIMARY KEY (id)
);

CREATE TABLE censeq_localization_text (
    id uuid NOT NULL,
    tenant_id uuid,
    ...
    last_modification_time timestamp without time zone,
    last_modifier_id uuid,
    CONSTRAINT pk_censeq_localization_text PRIMARY KEY (id)
);
...
CREATE UNIQUE INDEX ix_censeq_localization_culture_tenant_id_culture_name ON censeq_localization_culture (tenant_id, culture_name);

CREATE UNIQUE INDEX ix_censeq_localization_resource_name ON censeq_localization_resource (name);

CREATE UNIQUE INDEX ix_censeq_localization_text_tenant_id_resource_name_culture_na ON censeq_localization_text (tenant_id, resource_name, culture_name, key);
...
VALUES ('20260524142940_InitialDb', '8.0.16');
