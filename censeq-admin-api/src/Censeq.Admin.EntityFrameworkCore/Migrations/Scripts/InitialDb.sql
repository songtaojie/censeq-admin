...
CREATE TABLE censeq_permission_group_definition_record (
    id uuid NOT NULL,
    name character varying(128) NOT NULL,
    display_name character varying(256) NOT NULL,
    extra_properties text NOT NULL,
    CONSTRAINT pk_censeq_permission_group_definition_record PRIMARY KEY (id)
);
...
CREATE UNIQUE INDEX ix_censeq_permission_group_definition_record_name ON censeq_permission_group_definition_record (name);
