...
{
    internal static class CenseqFeatureManagementDbContextModelCreatingExtensions
    {
        public static void ConfigureFeatureManagement(this ModelBuilder builder)
        {
            ...
            {
                b.ToCenseqTable(nameof(FeatureValue));
            ...
            {
                b.ToCenseqTable(nameof(FeatureGroupDefinitionRecord))
            ...
            {
                b.ToCenseqTable(nameof(FeatureDefinitionRecord))
                    .ConfigureCenseqByConvention();
