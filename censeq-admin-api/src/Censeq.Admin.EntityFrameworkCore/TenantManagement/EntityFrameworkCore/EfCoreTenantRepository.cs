...
using Censeq.Admin.TenantManagement.EntityFrameworkCore;

namespace Censeq.Admin.EntityFrameworkCore.TenantManagement;
/// <summary>
/// EfCoreTenantRepository
/// </summary>
public class EfCoreTenantRepository : EfCoreRepository<CenseqAdminDbContext, Tenant, Guid>, ITenantRepository
{
    public EfCoreTenantRepository(IDbContextProvider<CenseqAdminDbContext> dbContextProvider, IAbpLazyServiceProvider abpLazyServiceProvider):base(dbContextProvider)
    {
