...
public static class CenseqIdentityDbContextModelBuilderExtensions
{
    public static void ConfigureIdentity([NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "Users", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "UserClaims", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "UserRoles", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "UserLogins", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "UserTokens", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "Roles", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "RoleClaims", CenseqIdentityDbProperties.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "ClaimTypes", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "OrganizationUnits", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "OrganizationUnitRoles", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "UserOrganizationUnits", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "SecurityLogs", CenseqIdentityDbProperties.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "LinkUsers", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "UserDelegations", CenseqIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqIdentityDbProperties.DbTablePrefix + "Sessions", CenseqIdentityDbProperties.DbSchema);
        ...
        builder.TryConfigureObjectExtensions<CenseqIdentityDbContext>();
    }
}
