...
public static class CenseqTenantManagementDbContextModelCreatingExtensions
{
        ...
        this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(CenseqTenantManagementDbProperties.DbTablePrefix + "Tenants", CenseqTenantManagementDbProperties.DbSchema);
        ...
        {
            b.ToTable(CenseqTenantManagementDbProperties.DbTablePrefix + "TenantConnectionStrings", CenseqTenantManagementDbProperties.DbSchema);
